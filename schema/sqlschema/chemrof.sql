...
--     * Slot: has_chemical_role_id
--     * Slot: owl_subclass_of_id Description: Holds between C and P if C owl:subClassOf P. Note that in this model, most classes are metaclasses (see 'owl class'), where these metaclasses may represent *groupings* or specific countable elements or species. We provide two different sub-properties of subclass of for two cases: (1) subtype_of, which connects grouping classes (e.g. alkane is_a hydrocarbon; alpha-amino-acid is_a amino-acid), (2) classified_by, which connects a specific element to a grouping class (e.g. methane is_a hydrocarbon; iron is_a metal; serine is_a amino-acid)
-- # Class: DecaySeries Description: A sequential chain of radioactive decays from a parent radionuclide through multiple daughter products to a stable end product
--     * Slot: parent_nuclide Description: The primordial radionuclide that starts the decay series
--     * Slot: stable_end_product Description: The stable isotope where the decay series ends
--     * Slot: series_name Description: Common name for the decay series (e.g. Uranium series, Thorium series, Actinium series)
--     * Slot: id
--     * Slot: name Description: name of chemical entity. E.g. nickel, carbon-16
--     * Slot: type
...
--     * Slot: decay_series Description: Which decay series this isotope belongs to, if any
--     * Slot: position_in_series Description: Ordinal position in the decay chain (1 for parent nuclide)
--     * Slot: branching_ratio Description: For isotopes with multiple decay modes, the fraction of decays that follow each path (value between 0 and 1)
--     * Slot: energy_level Description: e.g. ground, stable
--     * Slot: atomic_number Description: number of protons in an atom
--     * Slot: symbol Description: short symbol for chemical entity, e.g. K, C-16
--     * Slot: name Description: name of chemical entity. E.g. nickel, carbon-16
...
--     * Slot: Radionuclide_id Description: Autocreated FK slot
--     * Slot: pka_ionization_constant Description: The negative logarithm of the acid dissociation constant (Ka) for ionizable groups in a molecule. Multiple pKa values may exist for molecules with multiple ionizable groups.
-- # Class: DecaySeries_series_members
--     * Slot: DecaySeries_id Description: Autocreated FK slot
--     * Slot: series_members_id Description: Ordered list of isotopes in the decay chain
...
CREATE TABLE "DecaySeries" (
	parent_nuclide TEXT,
	stable_end_product TEXT,
	series_name TEXT,
	id TEXT NOT NULL,
	name TEXT,
	type TEXT,
	PRIMARY KEY (id),
	FOREIGN KEY(parent_nuclide) REFERENCES "Isotope" (id),
	FOREIGN KEY(stable_end_product) REFERENCES "Isotope" (id)
);CREATE INDEX "ix_DecaySeries_id" ON "DecaySeries" (id);
CREATE TABLE "Isotope" (
	...
	FOREIGN KEY(decay_series) REFERENCES "DecaySeries" (id),
...
CREATE TABLE "DecaySeries_series_members" (
	"DecaySeries_id" TEXT,
	series_members_id TEXT,
	PRIMARY KEY ("DecaySeries_id", series_members_id),
	FOREIGN KEY("DecaySeries_id") REFERENCES "DecaySeries" (id),
	FOREIGN KEY(series_members_id) REFERENCES "Isotope" (id)
);CREATE INDEX "ix_DecaySeries_series_members_DecaySeries_id" ON "DecaySeries_series_members" ("DecaySeries_id");CREATE INDEX "ix_DecaySeries_series_members_series_members_id" ON "DecaySeries_series_members" (series_members_id);
...
);CREATE INDEX "ix_Copolymer_polymer_of_polymer_of_id" ON "Copolymer_polymer_of" (polymer_of_id);CREATE INDEX "ix_Copolymer_polymer_of_Copolymer_id" ON "Copolymer_polymer_of" ("Copolymer_id");
